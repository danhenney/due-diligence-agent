...
타겟 CEO를 동종업계 상장사 CEO 3명과 비교:

| 항목 | 타겟 CEO | 비교 CEO A | 비교 CEO B | 비교 CEO C |
|------|---------|-----------|-----------|-----------|
| 재직 기간 | | | | |
| 이전 경력 | | | | |
| 주요 성과 | | | | |
...
## 조직 건전성 스코어 (Org Health Score)

5개 축으로 조직 건전성을 정량 평가:

| 축 | 지표 | 점수 (1-10) | 근거 |
|----|------|-----------|------|
| 리더십 안정성 | C-suite 평균 재직기간, 최근 이탈률 | | |
| 인재 확보력 | 채용 공고 수, 핵심 포지션 공석 기간 | | |
| 직원 만족도 | Glassdoor/잡플래닛 평점, 리뷰 트렌드 | | |
| 조직 효율성 | 1인당 매출, 인건비 비율 추이 | | |
| 승계 계획 | 핵심 인력 후계자 존재 여부 | | |

총점 50점 만점. 30점 미만 → 조직 리스크 플래그.
Glassdoor/잡플래닛 3.0 미만 → 자동 WARNING.
